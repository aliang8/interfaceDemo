...
public abstract class Actor implements Comparable<Actor>{
	...
	//   you need to make, and where you want the methods to go.
        ...
        //Part 3
	/*Store the primary stat you want for each type of actor
	  Then check actor type
	  If actor being compared is Barbarian, store strength into primary stat variable, similarly for the other actor types
 	  Use function to compare the variable
	 */
